...
#     catagory1=catagory.objects.filter(status=0)
#     return render(request,'sliderpage/collections.html',{'datas':catagory1})
...
def collections(request):
  ...
  return render(request,"inc/collections.html",{"catagory":catagory})  
...
def catagorys (request):
  catagory1=Catagory.objects.filter(status=0)
  return render(request,"layouts/frontpage.html",{"catagory":catagory1})
